    ...
    >
      ...
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12 mt-10 ">
          ...
          <p
            ...
            className="font-normal text-base leading-6 text-gray-600 mt-6"
          >
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p
            style={{ color: "darkgray" }}
            className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12"
          >
            It is a long established fact that a reader will be distracted by
            the readable content of a page when looking at its layout. The point
            of using Lorem Ipsum.In the first place we have granted to God, and
          ...
          <p
            style={{ color: "darkgray" }}
            className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10"
          >
            It is a long established fact that a reader will be distracted by
            the readable content of a page when looking at its layout. The point
            of using Lorem Ipsum.In the first place we have granted to God, and
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                <p
                  style={{ color: "#e0dcd6" }}
                  className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800"
                >
                  Team
                </p>
                <p
                  style={{ color: "darkgray" }}
                  className="mt-2 font-normal text-base leading-6 text-gray-600"
                >
