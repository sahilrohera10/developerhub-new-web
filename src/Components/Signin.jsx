...
const Signin = () => {
  return (
    ...
    <section className=" signContainer h-screen " style={{background:'white'}}>
            ...
            <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
              <form>
                ...
                <div className="flex justify-between items-center mb-6">
                 ...
                 <Link to='/forgot'> <a className="text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 duration-200 transition ease-in-out">Forgot password?</a></Link> 
                  <Link to='/form'> <a className="text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 duration-200 transition ease-in-out">Sign Up</a></Link>
                </div>
                {/* Submit button */}
                <Button variant="contained" fullWidth>Sign In</Button>
                <div className="justify-center flex items-center my-4 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 after:border-t after:border-gray-300 after:mt-0.5">
